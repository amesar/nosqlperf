 ...
 * @author andre
 */
public class HectorKeyValueDao<X extends KeyValue> implements KeyValueDao {
	private static final Logger logger = Logger.getLogger(HectorKeyValueDao.class);
	...
	public HectorKeyValueDao(Keyspace keyspace, String columnFamilyName, ObjectMapper<KeyValue> entityMapper) {
